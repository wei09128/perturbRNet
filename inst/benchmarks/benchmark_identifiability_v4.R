...
# perturbRNet Benchmark 4: does geometric identifiability predict recovery?
# Usage: Rscript benchmark_identifiability_v4.R quick|full
...
output_dir <- paste0("benchmark_identifiability_v4_", mode)
...
if (mode == "quick") {
  ...
  grid <- expand.grid(
    unique_targets = c(0, 1, 2, 5, 10, 20, 40, 80),
...
summary_lines <- c(
  paste0("perturbRNet Benchmark 4: ", mode),
